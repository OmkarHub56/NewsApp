...
//                    }
    ...
    public void onAttach(@NonNull Context context) {
        pl("Business Fragment onAttach");
        super.onAttach(context);
    }

    @Override
    public void onCreate(@Nullable Bundle savedInstanceState) {
        pl("Business fragment onCreate");
        super.onCreate(savedInstanceState);
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        pl("Business fragment onViewCreated");
        super.onViewCreated(view, savedInstanceState);
    }

    @Override
    public void onStart() {
        pl("Business Fragment onStart");
        super.onStart();
    }

    @Override
    public void onResume() {
        pl("Business fragment onResume");
        super.onResume();
    }

    @Override
    public void onPause() {
        pl("Business fragment onPause");
        super.onPause();
    }

    @Override
    public void onStop() {
        pl("Business fragment onStop");
        super.onStop();
    }

    @Override
    public void onDestroy() {
        pl("Business fragment onDestroyed");
        super.onDestroy();
    }

    @Override
    public void onDestroyView() {
        pl("Business fragment onDestroyView");
        super.onDestroyView();
    }

    @Override
    public void onDetach() {
        pl("Business Fragment onDetach");
        super.onDetach();
    }
